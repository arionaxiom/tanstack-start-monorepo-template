...
function AttachmentDescription({
  ...
  return (
    <span
      ...
      className={cn(
        "mt-0.5 block min-w-0 truncate text-xs text-muted-foreground group-data-[state=error]/attachment:text-destructive-emphasis/80",
        "max-w-full",
        className
      )}
      {...props}
