...
const toggleVariants = cva(
  cn(
    ...
    "aria-pressed:bg-muted aria-pressed:text-foreground data-pressed:bg-muted data-pressed:text-foreground",
  ...
  ),
  {
    variants: {
      variant: {
        default: "border-0",
        outline: "border border-border shadow-none hover:bg-muted",
      },
      size: {
        default:
