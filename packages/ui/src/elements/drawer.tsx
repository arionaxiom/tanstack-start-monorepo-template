...
function Drawer({
  ...
  const contextValue = React.useMemo(
    ...
    [direction, hasSnapPoints, modal, showSwipeHandle, swipeDirection]
  );
...
function DrawerContent({
  ...
  const { direction, hasSnapPoints, modal, showSwipeHandle, swipeDirection } =
    useDrawer();
  const swipeAxis =
